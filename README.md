...
принимает объект с функторами и скоуп. на один скоуп может быть назначен только один объект.
если надо перестать обрабатывать события этого скоупа - передается пустой объект

при игре 2х игроков, после установления соединения игроки не должны видеть отличия в интерфейсе сервера и клиента

установив скоуп нужно ждать ответа от всех участников, что они тоже зарегались в новом скоупе

админский скоуп позволяет релоадить игру, переходить на поизвольный урл, вызывать вибрацию
